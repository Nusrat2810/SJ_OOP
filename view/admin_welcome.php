   ...
   <body>
         ...
         <ul>
            <li class="hh"><i class="fas fa-align-justify"></i>
               <ul>
                  ...
                  <li><a href="p_requests.php">Post Requests</a></li>
                  <li><a href="users.php">All Users</a></li>
                  <li><a href="admin_welcome.php?q=logout">Logout</a></li>
               </ul>
            </li> 
      ...
      <div class="c6" align="center">
         ...
         <form action="" method="POST" target="">
            <input type='text' name='cat' required placeholder="Add a categoy of your question" ></input>
            <input type='text' name='qsn' required placeholder="Write your question here"></input>
